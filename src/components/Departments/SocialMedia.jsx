                ...
                >
                  ...
                  <div className="space-y-0.5">
                    {dayPosts.slice(0, 3).map(post => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isDraft ? <span className="text-3xs uppercase tracking-wider mr-0.5">Tentative</span> : null}
                          {post.title}
                        </div>
                      );
                    })}
                    {dayTasks.slice(0, 2).map(t => (
                      <div key={t.id}
                        className="text-xs px-1.5 py-0.5 rounded bg-orange-500/15 text-orange-400 truncate"
                        title={t.title}
                      >
                        📌 {t.title}
                      </div>
                    ...
                    {(dayPosts.length + dayTasks.length) > 4 && (
                      <div className="text-xs text-slate-500 pl-1">+{dayPosts.length + dayTasks.length - 4} more</div>
                    )}
                  </div>
